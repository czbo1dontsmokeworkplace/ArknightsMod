...
{
    public class ChitinousBlade : ModItem
    {
        ...
        {
            player.GetModPlayer<ChitinousBladePlayer>().hasChitinousBlade = true;
        }
    }

    public class ChitinousBladePlayer : ModPlayer
    {
        ...
        private void ApplyEffects()
        {
            ...
            if (selectedMinionIndex >= 0 && selectedMinionIndex < Main.maxProjectiles)
            {
                ...
                if (proj.active)
                {
                    ...
                    var globalProj = proj.GetGlobalProjectile<ChitinousBladeGlobalProjectile>();
            ...
            if (selectedPlayerForDamageIndex >= 0 && selectedPlayerForDamageIndex < Main.maxPlayers)
            {
                ...
                if (targetPlayer.active)
                {
                    ...
                    var modPlayer = targetPlayer.GetModPlayer<ChitinousBladeTargetPlayer>();
            ...
            if (selectedNPCIndex >= 0 && selectedNPCIndex < Main.maxNPCs)
            {
                ...
                {
                    var globalNPC = npc.GetGlobalNPC<ChitinousBladeGlobalNPC>();
    ...
    // 用于存储玩家伤害和生命值修改状态的类
    public class ChitinousBladeTargetPlayer : ModPlayer
    {
    ...
    // 用于存储投射物伤害修改状态的类
    public class ChitinousBladeGlobalProjectile : GlobalProjectile
    {
    ...
    // 用于存储NPC生命值修改状态的类
    public class ChitinousBladeGlobalNPC : GlobalNPC
    {
        public override bool InstancePerEntity => true;
