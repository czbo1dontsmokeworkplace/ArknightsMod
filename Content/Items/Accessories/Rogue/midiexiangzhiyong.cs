...
{
    public class midiexiangzhiyong : ModItem
    {
        ...
        {
            player.GetModPlayer<midiexiangzhiyongPlayer>().tranquilityCount++;
        }
    }

    public class midiexiangzhiyongPlayer : ModPlayer
    {
    ...
    public class midiexiangzhiyongGlobalNPC : GlobalNPC
    {
        ...
        private void ApplyHealthReduction(NPC npc)
        {
            ...
            for (int i = 0; i < Main.maxPlayers; i++)
            {
                ...
                {
                    totalCount += player.GetModPlayer<midiexiangzhiyongPlayer>().tranquilityCount;
                }
            }
