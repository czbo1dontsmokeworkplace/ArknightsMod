	...
	public class RAMeatchip : ModItem
	{
		public override void SetStaticDefaults() {
			...
			ItemID.Sets.FoodParticleColors[Item.type] = new Color[3] {
				new Color(249, 230, 36),
				new Color(152, 93, 95),
				new Color(174, 192, 92)
			};
		...
		public override void SetDefaults() {
			...
			Item.DefaultToFood(32, 32, BuffID.WellFed3, 18000); // 57600 is 16 minutes: 16 * 60 * 60
		...
		public override void OnConsumeItem(Player player) {
			...
			player.AddBuff(ModContent.BuffType<RAMeatchipBuff>(), 18000);
		}
