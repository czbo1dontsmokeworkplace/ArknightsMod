...
namespace ArknightsMod.Content.Items.Consumables
{
	...
	public class DehydratedSeasonedJerky : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.DefaultToFood(32, 32, BuffID.WellFed2, 32400); 
		...
		public override void OnConsumeItem(Player player) {
			...
			player.AddBuff(ModContent.BuffType<DehydratedSeasonedJerkyBuff>(), 32400);
		}


		public override void AddRecipes() {
			Recipe recipe = CreateRecipe();
			recipe.AddIngredient<Content.Items.Material.ReclamAlgor.Legmeat>(1);
