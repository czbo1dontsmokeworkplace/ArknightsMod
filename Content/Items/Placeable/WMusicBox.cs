...
{
	public class WMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			//MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sound/Music/Wmusic"), ModContent.ItemType<WMusicBox>(), ModContent.TileType<WMusicBoxTile>()); //file not found
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<WMusicBoxTile>(), 0);
		}
	}
}
