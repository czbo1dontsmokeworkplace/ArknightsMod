...
namespace ArknightsMod.Content.Items.Armor.Endfield.Guard.Endministrator
{
	...
	{
		public override string Texture => "ArknightsMod/Content/Items/Armor/Endfield/Guard/Endministrator/Endmin_Female_Mask_Item";
		public int Rarity => 6;
		...
		public override void Load()
		{
			...
			EquipLoader.AddEquipTexture(Mod, "ArknightsMod/Content/Items/Armor/Endfield/Guard/Endministrator/Endmin_Female_Mask", EquipType.Face, this, Name);
		}
		...
		internal class EndministratorMaskLayer : PlayerDrawLayer
		{
			...
			protected override void Draw(ref PlayerDrawSet drawInfo)
			{
				...
				Texture2D texture = ModContent.Request<Texture2D>("ArknightsMod/Content/Items/Armor/Endfield/Guard/Endministrator/Endmin_Female_Mask").Value;
