...
namespace ArknightsMod.Content.Items.Armor.Sniper.Fiammetta
{
	...
	public class FiammettaHead : NeoArmorHead
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<FiammettaBody>() && body.neoarmor().hasUpgraded &&
				legs.type == ModContent.ItemType<FiammettaLegs>() && legs.neoarmor().hasUpgraded;
		}
