...
namespace ArknightsMod.Content.Items.Weapons
{
    public class WuQi_Item_JiCi : UpgradeWeaponBase
	{
		...
		public override void HoldItem(Player player) {
			...
			if (Main.myPlayer == player.whoAmI) {
				if (Item.type != ModContent.ItemType<WuQi_Item_JiCi>()) {
					player.GetModPlayer<jici2player>().JiCi2 = false;
				}
				if (modPlayer.Skill == 1 && modPlayer.SkillActive&&Item.type == ModContent.ItemType<WuQi_Item_JiCi>()) {
    ...
    {
        public override string Texture => "ArknightsMod/Content/Items/Weapons/ThornsSword";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D 贴图1 = ModContent.Request<Texture2D>("ArknightsMod/Content/Items/Weapons/ThornsSword").Value;
            Main.spriteBatch.End();
            Main.spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, Main.DefaultSamplerState, DepthStencilState.None, Main.Rasterizer, null, Main.GameViewMatrix.TransformationMatrix);
    ...
    {
        public override string Texture => "ArknightsMod/Content/Items/Weapons/JiCi3";
        public override void SetDefaults()
        {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D 贴图1 = ModContent.Request<Texture2D>("ArknightsMod/Content/Items/Weapons/JiCi3").Value;
