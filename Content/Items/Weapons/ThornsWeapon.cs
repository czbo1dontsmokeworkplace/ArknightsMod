...
namespace ArknightsMod.Content.Items.Weapons
{
    ...
    {
        public override string Texture => "ArknightsMod/Content/Items/Weapons/ThornsWeaponProj";
        public override void SetDefaults()
        {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D 贴图1 = ModContent.Request<Texture2D>("ArknightsMod/Content/Items/Weapons/ThornsWeaponProj").Value;
