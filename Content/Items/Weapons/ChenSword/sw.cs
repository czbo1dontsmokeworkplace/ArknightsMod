...
{ 
    ...
    public class sw_Proj_1 : ModProjectile
    {
        ...
        public override void Load()
        {
            ...
            Skill_1_Release_Effect_1 = ModContent.Request<Texture2D>("ArknightsMod/Content/Items/Weapons/ChenSword/Skill_1_Release_Effect_1", AssetRequestMode.ImmediateLoad).Value;
    ...
    public class sw_Proj_2 : ModProjectile
    {
		...
		public override void Load()
        {
            ...
            sw_Proj_2_t2 = ModContent.Request<Texture2D>("ArknightsMod/Content/Items/Weapons/ChenSword/sw_Proj_2_t2", AssetRequestMode.ImmediateLoad);
            base.Load();
        }
        public override void SetDefaults()
        {
