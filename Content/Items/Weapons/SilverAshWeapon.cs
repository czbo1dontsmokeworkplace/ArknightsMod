...
namespace ArknightsMod.Content.Items.Weapons
{
    ...
    {
        public override string Texture => "ArknightsMod/Content/Items/Weapons/SilverAshWeapon2";
        public override void SetDefaults()
        {
    ...
    public class yinhdsz6 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {            
                ...
                Main.graphics.GraphicsDevice.BlendState = BlendState.AlphaBlend;
                strip2.DrawTrail();
                Texture2D 贴图1 = ModContent.Request<Texture2D>("ArknightsMod/Content/Items/Weapons/SilverAshWeapon3").Value;
                Main.spriteBatch.End();
                Main.spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, Main.DefaultSamplerState, DepthStencilState.None, Main.Rasterizer, null, Main.GameViewMatrix.TransformationMatrix);
