...
namespace ArknightsMod.Content.Items.Weapons
{
    public class SchwarzBow : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.UseSound = SchwarzAttackSound;
        ...
        SoundStyle SchwarzAttackSound = new SoundStyle("ArknightsMod/Assets/Sound/SchwarzAttackSound") with
        {
            Volume = 0.5f,
            PitchVariance = 0.3f,
            MaxInstances = 0,
        ...
        SoundStyle SchwarzSkillSound = new SoundStyle("ArknightsMod/Assets/Sound/SchwarzSkillSound") with
        {
            Volume = 0.5f,
            PitchVariance = 0.3f,
            MaxInstances = 0,
		...
		*/
        ...
        public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback) {
            float damageAdd = 0f;
            int type1 = type;
            int type2 = ModContent.ProjectileType<ArmorPiercingArrowhead>();
            int[] projectileTypes = new[] {
                  type1, type1, type1, type1, type2,
                };
            if (type == ProjectileID.WoodenArrowFriendly)
            { // or ProjectileID.WoodenArrowFriendly
                type = ModContent.ProjectileType<Projectiles.ArmorPiercingArrowhead>(); // or ProjectileID.FireArrow;
                damageAdd = damage * 2.88f;
                damageAdd = damageAdd - damage;
                damage = damage + (int)damageAdd;
                Item.useTime = 60;
                Item.useAnimation = 60;
                Item.UseSound = SchwarzSkillSound;
            }
            else if (type != ProjectileID.WoodenArrowFriendly)
            {
                type = Main.rand.Next(projectileTypes);
                damage = damage - (int)damageAdd;
                Item.useTime = 48;
