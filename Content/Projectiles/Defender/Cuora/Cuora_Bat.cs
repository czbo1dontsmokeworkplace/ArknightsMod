...
public class Cuora_Bat : ModProjectile
{
	Player player => Main.player[Projectile.owner];
	Item item => player.HeldItem;
	private Texture2D SwordTex { get => TextureAssets.Projectile[ModContent.ProjectileType<Cuora_Bat>()].Value; }
	...
	public void Move() {
		...
		if (Main.myPlayer == player.whoAmI) {
			...
			if (!modPlayer.DefensiveStance && !Main.mouseRight &&
