...
namespace ArknightsMod.Content.Projectiles.Defender.Beagle
{
	...
	public class MGL_Sword : ModProjectile
    {
        ...
        {
            Projectile.width = 10; // Ͷ�������ײ�����
            Projectile.height = 10; // Ͷ�������ײ��߶�
            Projectile.friendly = true; // Ͷ������Ի��е���
            Projectile.penetrate = -1; // Ͷ�������޴�͸
            Projectile.tileCollide = false; // Ͷ���ﲻ����Ƭ��ײ
            Projectile.usesLocalNPCImmunity = true; // ʹ�þֲ�����֡
            Projectile.ownerHitCheck = true; // ȷ��Ͷ�����ӵ���������߿�����׼Ŀ�꣨�����ܴ�Խ��Ƭ����Ŀ�꣩
            Projectile.DamageType = DamageClass.MeleeNoSpeed; // Ͷ����Ϊ��սͶ����
        ...
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.TrailCacheLength[Type] = 7;//��һ�������¼�Ĺ켣�����׷�ݵ�����֡��ǰ(ע�����ֵȡ����)
        }
