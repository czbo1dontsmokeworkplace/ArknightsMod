...
namespace ArknightsMod.Content.Projectiles.Schwarz
{
    public class ArmorPiercingArrowhead : ModProjectile
    {
        ...
        {
            SoundEngine.PlaySound(SchwarzHitSound);
            ...
            //int PenNibDust = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, ModContent.DustType<ArknightsWeapons.Dusts.PenNibDust>(), 0f, 0f, 150, default(Color), 0.9f);
