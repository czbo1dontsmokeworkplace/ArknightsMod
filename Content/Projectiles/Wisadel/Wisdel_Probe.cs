...
using WisdelItem = ArknightsMod.Content.Items.Weapons.WisadelCannon;
...
namespace ArknightsMod.Content.Projectiles.Wisadel
{
    public class Wisdel_Probe : ModProjectile
    {
		...
		/// 部署召唤
		/// </summary>
		public static SoundStyle Summon = new(ArknightsMod.PathProjectileExclusives + "Wisadel/WisdelCannon/WisdelSummon");
		/// <summary>
		/// 普攻发射
		/// </summary>
		public static SoundStyle Shoot = new(ArknightsMod.PathProjectileExclusives + "Wisadel/WisdelCannon/WisdelShoot");
		/// <summary>
		/// 普攻命中
		/// </summary>
		public static SoundStyle ShootBlast = new(ArknightsMod.PathProjectileExclusives + "Wisadel/WisdelCannon/WisdelShootBlast");
		/// <summary>
		/// 普攻重新装填
		/// </summary>
		public static SoundStyle ShootReload = new(ArknightsMod.PathProjectileExclusives + "Wisadel/WisdelCannon/WisdelReload");
		/// <summary>
		/// 技能开启
		/// </summary>
		public static SoundStyle SkillActivate = new(ArknightsMod.PathProjectileExclusives + "Wisadel/WisdelCannon/SkillActivate");
		/// <summary>
		/// 三技能锁定
		/// </summary>
		public static SoundStyle Aim = new(ArknightsMod.PathProjectileExclusives + "Wisadel/WisdelCannon/WisdelAim");
		/// <summary>
		/// 三技能爆破
		/// </summary>
		public static SoundStyle Explode = new(ArknightsMod.PathProjectileExclusives + "Wisadel/WisdelCannon/WisdelBoom");
		#endregion
        ...
        public override bool PreDraw(ref Color lightColor) {
			...
			Player player = Main.player[Projectile.owner];
			Texture2D texture = ModContent.Request<Texture2D>($"ArknightsMod/Content/Projectiles/Wisadel/Wisdel_Probe{Style}").Value;
			Texture2D glowTex = ModContent.Request<Texture2D>($"ArknightsMod/Content/Projectiles/Wisadel/Wisdel_Probe_Glow{Style}").Value;
