...
namespace ArknightsMod.Content.Projectiles.Wisadel
{
	public class WisdelExplode : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Texture2D texbase = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisadel/WisdelExplodeBase").Value;
			Texture2D tex = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisadel/WisdelExplode").Value;
			Texture2D texglow = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisadel/WisdelExplode_Glow").Value;
			Texture2D hightlight = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisadel/star_02").Value;
