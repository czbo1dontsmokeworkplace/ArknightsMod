...
namespace ArknightsMod.Content.Projectiles.Wisadel
{
	public class WisdelShotBigCircle : ModProjectile
	{
        ...
        private Effect trail = ModContent.Request<Effect>("ArknightsMod/Content/Projectiles/Wisadel/Wisdel",
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.graphics.GraphicsDevice.Textures[0] = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisadel/Trail1_NonPrem").Value;
            ...
            Main.graphics.GraphicsDevice.Textures[1] = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisadel/noise26").Value;
