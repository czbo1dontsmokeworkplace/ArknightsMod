...
namespace ArknightsMod.Content.Projectiles.Wisdel
{
	public class WisdelShotBigCircle : ModProjectile
	{
        ...
        private Effect trail = ModContent.Request<Effect>("ArknightsMod/Content/Projectiles/Wisdel/Wisdel",
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            // 椭圆轨迹上的点
            int pointCount = 30;
            Vector2[] ellipsePos = new Vector2[pointCount];
            ...
            Main.graphics.GraphicsDevice.Textures[0] = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisdel/Trail1_NonPrem").Value;
            ...
            Main.graphics.GraphicsDevice.Textures[1] = ModContent.Request<Texture2D>("ArknightsMod/Content/Projectiles/Wisdel/noise26").Value;
