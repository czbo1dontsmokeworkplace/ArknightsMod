...
namespace ArknightsMod.Content.Projectiles
{
    public class PenNib : ModProjectile
    {
        ...
        SoundStyle PenNibHit = new SoundStyle("ArknightsMod/Assets/Sound/PenNibHit")
        {
            Volume = 0.5f,
            MaxInstances = 0,
        };
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            int PenNibDust = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, ModContent.DustType<Dusts.PenNibDust>(), 0f, 0f, 150, default(Color), 0.9f);
