...
namespace ArknightsMod.Content.Projectiles.Sniper.Pozemka
{
	public class PozemkaCrossbow_Sentry_Projectile : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			...
			int HitSparkle = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, DustID.RainbowTorch, 0f, 0f, 150, default, 0.9f);
			int PenNibDust = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, ModContent.DustType<PozemkaCrossbowDust>(), 0f, 0f, 150, default, 0.9f);
