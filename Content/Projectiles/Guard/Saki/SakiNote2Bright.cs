...
namespace ArknightsMod.Content.Projectiles.Guard.Saki
{
	...
	/// 2技能法伤音符
	/// </summary>
    public class SakiNote2Bright : ModProjectile
    {
		...
		public override void SetDefaults()
        {
			...
			AIType = -1;
			style = Main.rand.NextBool(2) ? 1 : 3;
		...
		public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            Projectile.NewProjectile
                ...
                ModContent.ProjectileType<SakiSlashHit2>(), 0, 0, Projectile.owner);
        ...
        {
			Texture2D tex = ModContent.Request<Texture2D>($"ArknightsMod/Content/Projectiles/Guard/Saki/Note{style}").Value;
		...
		public void DrawTrail(int Width, string tex1, string tex2) {
			...
			for (int i = 1; i < OldPos.Length; ++i) {
				...
				for (int j = interp.Count - 1; j > 1; j--) {
					...
					Vector2 texCoord1 = new Vector2(factor, 1);
					Vector2 texCoord2 = new Vector2(factor, 0);
