...
{
    public class ThornsSlash : ModProjectile
    {
        ...
        public override bool PreDraw(Player player, ref Color lightColor)
        {
            ...
            if (sx)
            {
                Main.spriteBatch.Draw(texture, player.Center - Main.screenPosition + new Vector2(0, 5),
                    null, Color.AliceBlue, jd + 3.14f / 3.5f, new Vector2(10, texture.Size().Y - 10), Vector2.Distance(new Vector2(0), oldVec[0]) / 60, SpriteEffects.None, 0);
            }
            else
            {
                Main.spriteBatch.Draw(texture, player.Center - Main.screenPosition + new Vector2(0, 5),
                    null, Color.AliceBlue, jd - 3.14f - 3.14f / 3.5f, texture.Size() + new Vector2(-10), Vector2.Distance(new Vector2(0), oldVec[0]) / 60, SpriteEffects.FlipHorizontally, 0);
            }
            return false;
        }
    }
