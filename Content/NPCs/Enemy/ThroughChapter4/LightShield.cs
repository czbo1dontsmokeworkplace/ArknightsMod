...
{
	public class LightShield : ModNPC

	{
		...
		private int fadeOutTimer = 30; // 用于控制淡出效果的计时器
									   // 动画常量
		private int frameNumber = 26;//一共多少帧
		private int DefaultFrame = 5;//静止最后一帧是第几帧（-1）
		private int MoveStartFrame = 6;//移动开始帧
		...
		private int DeathEndFrame = 25;//死亡结束帧
