...
{
	public class RMA7012Tile : ModTile
	{
	...
	{
		public static LocalizedText RMA7012PassMessage { get; private set; }

		public override void SetStaticDefaults() {
			RMA7012PassMessage = Language.GetOrRegister(Mod.GetLocalizationKey($"WorldGen.{nameof(RMA7012PassMessage)}"));
		}
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration) {
			...
			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-04); k++) {
				...
				if (tile.HasTile && tile.TileType == TileID.Dirt) {
					WorldGen.TileRunner(x, y, WorldGen.genRand.Next(4, 6), WorldGen.genRand.Next(5, 8), ModContent.TileType<RMA7012Tile>());
				}
			}
		}
	}
