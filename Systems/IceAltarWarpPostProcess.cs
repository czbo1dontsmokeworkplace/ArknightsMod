...
namespace ArknightsMod.Systems
{
	...
	public sealed class IceAltarWarpPostProcess : ModSystem
	{
		...
		public override void Unload() {
			...
			try { On_FilterManager.EndCapture_RenderTarget2D_RenderTarget2D_RenderTarget2D_Vector2_Vector2_Vector2 -= FilterManager_EndCapture; } catch { }
		}
		...
		private static void FilterManager_EndCapture(On_FilterManager.orig_EndCapture_RenderTarget2D_RenderTarget2D_RenderTarget2D_Vector2_Vector2_Vector2 orig,
			...
			Vector2 screenSize, Vector2 sceneSize, Vector2 sceneOffset)
		{
